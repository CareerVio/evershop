...
export const provinces: Province[] = [
    ...
    { code: 'TH-37', countryCode: 'TH', name: 'อำนาจเจริญ' },
    { code: 'TH-15', countryCode: 'TH', name: 'อ่างทอง' },
    { code: 'TH-31', countryCode: 'TH', name: 'บุรีรัมย์' },
    { code: 'TH-24', countryCode: 'TH', name: 'ฉะเชิงเทรา' },
    { code: 'TH-18', countryCode: 'TH', name: 'ชัยนาท' },
    { code: 'TH-36', countryCode: 'TH', name: 'ชัยภูมิ' },
    { code: 'TH-22', countryCode: 'TH', name: 'จันทบุรี' },
    { code: 'TH-50', countryCode: 'TH', name: 'เชียงใหม่' },
    { code: 'TH-57', countryCode: 'TH', name: 'เชียงราย' },
    { code: 'TH-20', countryCode: 'TH', name: 'ชลบุรี' },
    { code: 'TH-86', countryCode: 'TH', name: 'ชุมพร' },
    { code: 'TH-46', countryCode: 'TH', name: 'กาฬสินธุ์' },
    { code: 'TH-62', countryCode: 'TH', name: 'กำแพงเพชร' },
    { code: 'TH-71', countryCode: 'TH', name: 'กาญจนบุรี' },
    { code: 'TH-40', countryCode: 'TH', name: 'ขอนแก่น' },
    { code: 'TH-81', countryCode: 'TH', name: 'กระบี่' },
    { code: 'TH-10', countryCode: 'TH', name: 'กรุงเทพมหานคร' },
    { code: 'TH-52', countryCode: 'TH', name: 'ลำปาง' },
    { code: 'TH-51', countryCode: 'TH', name: 'ลำพูน' },
    { code: 'TH-42', countryCode: 'TH', name: 'เลย' },
    { code: 'TH-16', countryCode: 'TH', name: 'ลพบุรี' },
    { code: 'TH-58', countryCode: 'TH', name: 'แม่ฮ่องสอน' },
    { code: 'TH-44', countryCode: 'TH', name: 'มหาสารคาม' },
    { code: 'TH-49', countryCode: 'TH', name: 'มุกดาหาร' },
    { code: 'TH-26', countryCode: 'TH', name: 'นครนายก' },
    { code: 'TH-73', countryCode: 'TH', name: 'นครปฐม' },
    { code: 'TH-48', countryCode: 'TH', name: 'นครพนม' },
    { code: 'TH-30', countryCode: 'TH', name: 'นครราชสีมา' },
    { code: 'TH-60', countryCode: 'TH', name: 'นครสวรรค์' },
    { code: 'TH-80', countryCode: 'TH', name: 'นครศรีธรรมราช' },
    { code: 'TH-55', countryCode: 'TH', name: 'น่าน' },
    { code: 'TH-96', countryCode: 'TH', name: 'นราธิวาส' },
    { code: 'TH-39', countryCode: 'TH', name: 'หนองบัวลำภู' },
    { code: 'TH-43', countryCode: 'TH', name: 'หนองคาย' },
    { code: 'TH-12', countryCode: 'TH', name: 'นนทบุรี' },
    { code: 'TH-13', countryCode: 'TH', name: 'ปทุมธานี' },
    { code: 'TH-94', countryCode: 'TH', name: 'ปัตตานี' },
    { code: 'TH-82', countryCode: 'TH', name: 'พังงา' },
    { code: 'TH-93', countryCode: 'TH', name: 'พัทลุง' },
    { code: 'TH-56', countryCode: 'TH', name: 'พะเยา' },
    { code: 'TH-67', countryCode: 'TH', name: 'เพชรบูรณ์' },
    { code: 'TH-76', countryCode: 'TH', name: 'เพชรบุรี' },
    { code: 'TH-66', countryCode: 'TH', name: 'พิจิตร' },
    { code: 'TH-65', countryCode: 'TH', name: 'พิษณุโลก' },
    { code: 'TH-14', countryCode: 'TH', name: 'พระนครศรีอยุธยา' },
    { code: 'TH-54', countryCode: 'TH', name: 'แพร่' },
    { code: 'TH-83', countryCode: 'TH', name: 'ภูเก็ต' },
    { code: 'TH-25', countryCode: 'TH', name: 'ปราจีนบุรี' },
    { code: 'TH-77', countryCode: 'TH', name: 'ประจวบคีรีขันธ์' },
    { code: 'TH-85', countryCode: 'TH', name: 'ระนอง' },
    { code: 'TH-70', countryCode: 'TH', name: 'ราชบุรี' },
    { code: 'TH-21', countryCode: 'TH', name: 'ระยอง' },
    { code: 'TH-45', countryCode: 'TH', name: 'ร้อยเอ็ด' },
    { code: 'TH-27', countryCode: 'TH', name: 'สระแก้ว' },
    { code: 'TH-47', countryCode: 'TH', name: 'สกลนคร' },
    { code: 'TH-11', countryCode: 'TH', name: 'สมุทรปราการ' },
    { code: 'TH-74', countryCode: 'TH', name: 'สมุทรสาคร' },
    { code: 'TH-75', countryCode: 'TH', name: 'สมุทรสงคราม' },
    { code: 'TH-19', countryCode: 'TH', name: 'สระบุรี' },
    { code: 'TH-91', countryCode: 'TH', name: 'สตูล' },
    { code: 'TH-33', countryCode: 'TH', name: 'ศรีสะเกษ' },
    { code: 'TH-17', countryCode: 'TH', name: 'สิงห์บุรี' },
    { code: 'TH-90', countryCode: 'TH', name: 'สงขลา' },
    { code: 'TH-64', countryCode: 'TH', name: 'สุโขทัย' },
    { code: 'TH-72', countryCode: 'TH', name: 'สุพรรณบุรี' },
    { code: 'TH-84', countryCode: 'TH', name: 'สุราษฎร์ธานี' },
    { code: 'TH-32', countryCode: 'TH', name: 'สุรินทร์' },
    { code: 'TH-63', countryCode: 'TH', name: 'ตาก' },
    { code: 'TH-92', countryCode: 'TH', name: 'ตรัง' },
    { code: 'TH-23', countryCode: 'TH', name: 'ตราด' },
    { code: 'TH-34', countryCode: 'TH', name: 'อุบลราชธานี' },
    { code: 'TH-41', countryCode: 'TH', name: 'อุดรธานี' },
    { code: 'TH-61', countryCode: 'TH', name: 'อุทัยธานี' },
    { code: 'TH-53', countryCode: 'TH', name: 'อุตรดิตถ์' },
    { code: 'TH-95', countryCode: 'TH', name: 'ยะลา' },
    { code: 'TH-35', countryCode: 'TH', name: 'ยโสธร' },
